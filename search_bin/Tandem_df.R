...
Path <- Arg[1] ##Directorio relativo de trabajo
TanDist <- as.numeric(Arg[2]) ##Dist minima en bases entre dos tandems
Input <- Arg[3] ##Input dataframe
Output <- Arg[4] ##Output dataframe
